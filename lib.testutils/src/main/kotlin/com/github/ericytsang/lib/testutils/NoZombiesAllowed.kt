...
class NoZombiesAllowed:TestWatcher()
{
    companion object
    {
        ...
        private fun getAllChildrenOfThreadGroup(threadGroup:ThreadGroup,exceptions:Set<String>):List<Thread>
        {
        ...
        {
            // get worker threads
            val workerThreads = getAllChildrenOfThreadGroup(threadGroup,exceptions)
